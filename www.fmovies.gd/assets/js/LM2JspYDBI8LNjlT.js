const e = e => {
    ...
    n = e => {
        ...
        return i(Object.entries(e.classGroups), r).forEach(([e, r]) => {
            l(r, t, e, o)
        }), t
    },
    l = (e, o, r, t) => {
        e.forEach(e => {
            if ("string" == typeof e) {
                return void(("" === e ? o : s(o, e)).classGroupId = r)
            }
            if ("function" == typeof e) return a(e) ? void l(e(t), o, r, t) : void o.validators.push({
                validator: e,
                classGroupId: r
            });
    ...
    a = e => e.isThemeGetter,
    i = (e, o) => o ? e.map(([e, r]) => [e, r.map(e => "string" == typeof e ? o + e : "object" == typeof e ? Object.fromEntries(Object.entries(e).map(([e, r]) => [o + e, r])) : e)]) : e,
    d = e => {
        if (e < 1) return {
            get: () => {},
            set: () => {}
    ...
    c = e => {
        ...
        } = e, t = 1 === o.length, n = o[0], l = o.length, s = e => {
            const r = [];
            let s, a = 0,
                i = 0;
...
function g(o, ...r) {
    let t, n, l, s = function(i) {
        const p = r.reduce((e, o) => o(e), o());
        return t = (o => ({
            cache: d(o.cacheSize),
            parseClassName: c(o),
            ...e(o)
        }))(p), n = t.cache.get, l = t.cache.set, s = a, a(i)
    };
    ...
    J = g(() => {
        ...
        return {
            ...
            classGroups: {
                ...
                "object-position": [{
                    object: ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top", S]
                }],
                overflow: [{
                ...
                w: [{
                    w: ["auto", "min", "max", "fit", "svw", "lvw", "dvw", S, o]
                }],
                "min-w": [{
                    "min-w": [S, o, "min", "max", "fit"]
                }],
                "max-w": [{
                    "max-w": [S, o, "none", "full", "min", "max", "fit", "prose", {
                        screen: [$]
                    }, $]
                }],
                h: [{
                    h: [S, o, "auto", "min", "max", "fit", "svh", "lvh", "dvh"]
                }],
                "min-h": [{
                    "min-h": [S, o, "min", "max", "fit", "svh", "lvh", "dvh"]
                }],
                "max-h": [{
                    "max-h": [S, o, "min", "max", "fit", "svh", "lvh", "dvh"]
                }],
                size: [{
                    size: [S, o, "auto", "min", "max", "fit"]
                }],
                "font-size": [{
                    text: ["base", $, G]
                }],
                ...
                leading: [{
                    leading: ["none", "tight", "snug", "normal", "relaxed", "loose", j, S]
                }],
                "list-image": [{
                    "list-image": ["none", S]
                }],
                ...
                "text-decoration-thickness": [{
                    decoration: ["auto", "from-font", j, G]
                }],
                "underline-offset": [{
                    "underline-offset": ["auto", j, S]
                }],
                ...
                "bg-position": [{
                    bg: ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top", R]
                }],
                "bg-repeat": [{
                    bg: ["no-repeat", {
